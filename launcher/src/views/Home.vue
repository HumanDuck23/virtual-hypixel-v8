  ...
  <div>
    ...
    <v-dialog v-model="downloadDialog" max-width="400">
      <v-card color="primary">
        ...
        <v-card-text>
          Would you like the launcher to download the latest version of virtual-hypixel? <br>
...
export default {
  ...
  watch: {
    serverConfig: {
      handler(val) {
        localStorage.setItem("serverConfig", JSON.stringify(val))
      },
      deep: true
    }
  }
